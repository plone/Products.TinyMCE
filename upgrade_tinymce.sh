...
cp -R $root/tmp/tinymce_language_pack/langs/* $tinymce_root/langs/
cp -R $root/tmp/tinymce_language_pack/themes/advanced/langs/* $tinymce_root/themes/advanced/langs/
for f in $root/tmp/tinymce_language_pack/plugins/*
do
